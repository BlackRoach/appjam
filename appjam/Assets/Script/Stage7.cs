...
public class Stage7 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Player.GetComponent<PlayerStatus>().red == 4 && Player.GetComponent<PlayerStatus>().blue == 3 && Player.GetComponent<PlayerStatus>().green == 1)
        {
            PlayerPrefs.SetInt("SceneClear7", 1);
