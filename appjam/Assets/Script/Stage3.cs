...
public class Stage3 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Player.GetComponent<PlayerStatus>().red == 1 && Player.GetComponent<PlayerStatus>().blue == 1 && Player.GetComponent<PlayerStatus>().green == 1)
        {
            PlayerPrefs.SetInt("SceneClear3", 1);
