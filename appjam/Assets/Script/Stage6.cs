...
public class Stage6 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Player.GetComponent<PlayerStatus>().red == 3 && Player.GetComponent<PlayerStatus>().blue == 2 && Player.GetComponent<PlayerStatus>().green == 1)
        {
            PlayerPrefs.SetInt("SceneClear6", 1);
