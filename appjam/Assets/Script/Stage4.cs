...
public class Stage4 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Player.GetComponent<PlayerStatus>().red == 1 && Player.GetComponent<PlayerStatus>().blue == 1 && Player.GetComponent<PlayerStatus>().green == 2)
        {
            PlayerPrefs.SetInt("SceneClear4", 1);
